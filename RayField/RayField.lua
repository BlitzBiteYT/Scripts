...
function CloseSearch()
	Debounce = true
	-- Release keyboard focus before hiding the TextBox
	pcall(function() SearchBar.Input:ReleaseFocus() end)
...
function OpenSearch()
	Debounce = true
	-- Anchor the searchbar to the horizontal center, just below the topbar
	SearchBar.AnchorPoint = Vector2.new(0.5, 0)
	SearchBar.Position = UDim2.new(0.5, 0, 0, 52)
	SearchBar.Visible = true
	SearchBar.Input.Visible = true
	SearchBar.Input.TextEditable = true
	...
	wait(0.5)
	-- Focus the TextBox so the user can type immediately after the bar opens
	pcall(function() SearchBar.Input:CaptureFocus() end)
	Debounce = false
end
